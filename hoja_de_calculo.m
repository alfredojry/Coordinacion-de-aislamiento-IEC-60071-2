% Script similar a 'desarrollo.m', a diferencia que genera una hoja de cálculo en
% formato .xls 
...
cond_mxsob=cont_ener+cont_resis+cont_alim+cont_comp; %segï¿½n selecciï¿½n en el tooggle button
...
% Con Ue2, se busca en la curva la relaciï¿½n Up2/Ue2, considerando
% energizaciï¿½n o reenegizaciï¿½n trifï¿½sica
if (cont_ener==0)
...
% Cï¿½lculo de Uet y Upt. Uet es el valor truncado de la distribuciï¿½n
% acumulativa de los sobrevoltajes de fase a tierra. Upt es el valor
% truncado de la distribuciï¿½n acumulativa de los sobrevoltajes de fase a
% fase
Uet=1.25*Ue2-.25;
Upt=1.25*Up2-.43;
Uet_kV=Uet*Vbase;
Upt_kV=Upt*Vbase;
%Comparaciï¿½n de Uet con Ups y Upt con 2*Ups
...
% Sobretensiones temporales
Ucw_ff_temp=Urp_ff_temp; % Voltaje soportado de coordinaciÃ³n del equipo de fase a fase
Ucw_ft_temp=Urp_ft_temp; % Voltaje soportado de coordinaciÃ³n del equipo de fase a tierra
...
% DeterminaciÃ³n del factor de coordinaciÃ³n el cual varÃ­a para fase-fase y fase-tierra
...
% Sobretensiones de frente rÃ¡pido
La=Ra/Rkm; %
Ucw_rapido_int=Upl+(A/n)*(Lint/(Lsp+La));
Ucw_rapido_ext=Upl+((A/n)*(Lext/(Lsp+La)));


% **********DeterminaciÃ³n de las tensiones soportadas requeridas (Urw)**********

% Sobretensiones temporales
% m es el exponente en la formula del factor de correccion atmosferico para
% aislamiento externo
m1=1/2; % Este valor representa la situacion mas conservadora
Ka1=exp(m1*H/8150); % Ka es el factor de correccion atmosfÃ©rico
...
% Voltajes soportados de impluso tipo rayo
...
% Creación del fichero .xls

% Declaración de path del fichero
global camino
copyfile 'plantilla.xls' 'xlstemporal.xls'
archivo1='xlstemporal.xls';

% Escritura de sobrevoltajes representativos
temporales1={'Voltaje base (kV)',Vbase,' ';' ',' ',' ';'Procedimiento de determinación de sobrevoltajes representativos Urp',' ',' ';' ',' ',' ';'Sobrevoltajes temporales',' ',' ';' ','Fase-Tierra','Fase-Fase';'Falla a tierra',Urp_ft1,' ';'Rechazo de carga',Urp_ft2,Urp_ff_temp;'Selección',Urp_ft_temp,Urp_ff_temp};
frente_lento1={'','','';'Sobrevoltajes de frente lento','','';'ue2 p.u.',Ue2,'';'up2 p.u.',Up2,'';'uet p.u.',Uet,'';'upt p.u.',Upt,'';'Uet kV',Uet_kV,'';'Upt kV',Upt_kV,'';'Selección','Fase-Tierra','Fase-Fase';'',Urp_ft_lento,Urp_ff_lento};
resumen1={'Sobrevoltajes representativos Urp','','';'','Fase-Tierra','Fase-Fase';'Temporales',Urp_ft_temp,Urp_ff_temp;'Frente lento',Urp_ft_lento,Urp_ff_lento};
paso1=[temporales1;frente_lento1;resumen1];
% {}
xlswrite(archivo1,paso1,'Sobrevoltajes representativos','C3');

% Escritura de voltajes soportados de coordinación
temporales2={'Procedimiento de determinación de voltajes soportados de coordinación Ucw',' ',' ';'','','';'Sobrevoltajes temporales','','';'','Fase-Tierra','Fase-Fase';'',Ucw_ft_temp,Ucw_ff_temp};
frentelento2={'','','';'Sobrevoltajes de frente lento','','';'','Ups/Ue2','2*Ups/Ue2';'',cociente3,cociente2;'Factor de coordinación determinístico',Kcd_ft,Kcd_ff;'Ucw','Fase-Tierra','Fase-Fase';'',Ucw_ft_lento,Ucw_ff_lento};
frenterapido2={'','','';'Sobrevoltajes de frente rápido','','';'Longitud de la línea que produce una tasa de salida igual a la aceptable (La)',La,'';'Sobrevoltaje de aislamiento interno',Ucw_rapido_int,'';'Sobrevoltaje de aislamiento externo',Ucw_rapido_ext,''};
resumen2={'','','';'Voltajes soportados de coordinación','','';'','Fase-Tierra','Fase-Fase';'Temporales',Ucw_ft_temp,Ucw_ff_temp;'Frente lento',Ucw_ft_lento,Ucw_ff_lento;'Frente rápido aislamiento interno',Ucw_rapido_int,Ucw_rapido_int;'Frente rápido aislamiento externo',Ucw_rapido_ext,Ucw_rapido_ext};
paso2=[temporales2;frentelento2;frenterapido2;resumen2];
xlswrite(archivo1,paso2,'Soportados','C3');

% Escritura de voltajes soportados requeridos
temporales3={'Procedimiento de determinación de voltajes soportados requeridos Urw',' ',' ';'','','';'Sobrevoltajes temporales','','';'','Fase-Tierra','Fase-Fase';'Exponente de corrección atmosférica',m1,m1;'Factor de corrección atmosférico',Ka1,Ka1;'Sobretensiones temporales de aislamiento interno',Urw_ft_temp_int,Urw_ff_temp_int;'Sobretensiones temporales de aislamiento externo',Urw_ft_temp_ext,Urw_ff_temp_ext};
frentelento3={'','','';'Sobrevoltajes de frente lento','','';'','Fase-Tierra','Fase-Fase';'Exponente de corrección atmosférica',m3,m2;'Factor de corrección atmosférico',Ka3,Ka2;'Sobretensiones de frente lento de aislamiento interno',Urw_ft_temp_int,Urw_ff_temp_int;'Sobretensiones de frente lento de aislamiento externo',Urw_ft_lento_ext,Urw_ff_lento_ext};
frenterapido3={'','','';'Sobrevoltajes de frente rápido','','';'','Fase-Tierra','Fase-Fase';'Exponente de corrección atmosférica',m4,m4;'Factor de corrección atmosférico',Ka4,Ka4;'Sobretensiones de frente rápido de aislamiento interno',Urw_rapido_int,Urw_rapido_int;'Sobretensiones de frente rápido de aislamiento externo',Urw_rapido_ext,Urw_rapido_ext};
resumen3={'','','';'Voltajes soportados requeridos de aislamiento interno','','';'','Fase-Tierra','Fase-Fase';'Temporales',Urw_ft_temp_int,Urw_ff_temp_int;'Frente lento',Urw_ft_lento_int,Urw_ff_lento_int;'Frente rápido',Urw_rapido_int,Urw_rapido_int;'','','';'Voltajes soportados requeridos de aislamiento externo','','';'','Fase-Tierra','Fase-Fase';'Temporales',Urw_ft_temp_ext,Urw_ff_temp_ext;'Frente lento',Urw_ft_lento_ext,Urw_ff_lento_ext;'Frente rápido',Urw_rapido_ext,Urw_rapido_ext};
paso3=[temporales3;frentelento3;frenterapido3;resumen3];
xlswrite(archivo1,paso3,'Requeridos','C3');

% Escritura de los voltajes convertidos a soportados normalizados
frec_pot4={'Procedimiento de conversión a voltajes soportados normalizados','','';'','','';'Voltajes soportados a frecuencia de potencia','','';'','Fase-Tierra','Fase-Fase';'Aislamiento interno',Uw_ft_p_int,Uw_ff_p_int;'Aislamiento externo',Uw_ft_p_ext,Uw_ff_p_ext};
imp_rayo4={'','','';'Voltajes soportados a impulso tipo rayo','','';'','Fase-Tierra','Fase-Fase';'Aislamiento interno',Uw_ft_r_int,Uw_ff_r_int;'Aislamiento externo',Uw_ft_r_ext,Uw_ff_r_ext};
paso4=[frec_pot4;imp_rayo4];
xlswrite(archivo1,paso4,'Convertidos','C3');

reporte=[camino '\Reporte CASEP.xls'];
copyfile 'xlstemporal.xls' reporte

%INVOCA GUI DE PRESENTACIÃ“N DE RESULTADOS
Resultados