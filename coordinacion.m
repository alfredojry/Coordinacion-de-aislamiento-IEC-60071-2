...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
acerca=['     Yoelvis Jiménez      Luís Torrelles' char(10) char(10) '     Pedro Álvarez        Carlos Vásquez' char(10) char(10) '     Gerencia de Servicios Eléctricos' char(10) '        Petróleos de Venezuela, S.A.'];
